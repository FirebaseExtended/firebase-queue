...
QueueWorker.prototype._resolve = function(taskNumber) {
  ...
  var resolve = function(newQueueItem) {
    ...
    if ((taskNumber !== self.taskNumber) || _.isNull(self.currentItemRef)) {
 ...
 * @param {Object} jobSpec The specification for the job.
 */
QueueWorker.prototype.setTaskSpec = function(jobSpec) {
  var self = this;

  // Increment the taskNumber so that a job being processed before the change
